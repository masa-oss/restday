...
public class MockHttpServletRequest implements HttpServletRequest {
   ...
   public MockHttpServletRequest(ServletContext sc) {
    ...
    public BufferedReader getReader() throws IOException {
        if (buffRead == null) throw new IllegalStateException("MockHttpServletRequest#getReader");
        return buffRead;
    }
    ...
    static class PM implements Enumeration<String> {
  ...
  //      HashMap<String, String> param_map;
        ...
        public PM(HashMap<String, String> param_map) {
            
  //          this.param_map = param_map;
            list.addAll(param_map.keySet());
            size = list.size();
        }
    ...
    public void putParameter(String key, String val) {
        param_map.put(key, val);
    }
